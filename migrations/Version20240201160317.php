 ...
 */
final class Version20240201160317 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE session ADD CONSTRAINT FK_D044D5D46729D507 FOREIGN KEY (surfer_id) REFERENCES surfer (id)');
